...
| Streamlit demo URL | Renamed 2026-07-17 to `responsible-neobank-growth.streamlit.app` (from the old `appuct` workaround for Streamlit's 'prod' ban); registry `live-dashboard` (external) |
